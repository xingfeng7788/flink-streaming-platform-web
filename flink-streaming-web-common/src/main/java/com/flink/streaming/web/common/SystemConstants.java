...
public class SystemConstants {
    ...
    public static final String DEFAULT_FLINK_YARN_PORT = "8088";
    public static final String DEFAULT_FLINK_UI_PORT = "20888";
    public static final String DEFAULT_FLINK_CLUSTER_NAME_PREFIX = "datalake-emr-cluster-name-";
...
//    public static String getDefaultSavepointRootPath() {
//        String dir = System.getenv("DEFAULT_SAVEPOINT_ROOT_PATH");
//        if (dir == null) {
//            return DEFAULT_SAVEPOINT_ROOT_PATH;
//        } else {
//            return dir;
//        }
//    }
//    public static String getFlinkAddr(String addr) {
//      String flink = System.getenv("EXEC_FLINK");
//      if (flink.equals("EMR")) {
//        addr = addr.replace("8088", "20888");
//      }
//      return addr;
//    }


    public static boolean getIsMasterWeb() {
        String isMasterWeb = System.getenv("IS_MASTER_WEB");
        if (isMasterWeb == null) {
            return false;
        }
        return Boolean.parseBoolean(isMasterWeb);
    }
}
