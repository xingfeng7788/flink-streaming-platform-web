...
public class JobConfigHistoryDTO implements Serializable {
  ...
  public static JobConfigHistory toEntity(JobConfigHistoryDTO jobConfigHistoryDTO) {
    ...
    jobConfigHistory.setClusterId(jobConfigHistoryDTO.getClusterId());
    jobConfigHistory.setClusterName(jobConfigHistoryDTO.getClusterName());
  ...
  public static JobConfigHistoryDTO toDTO(JobConfigHistory jobConfigHistory) {
    ...
    jobConfigHistoryDTO.setClusterId(jobConfigHistory.getClusterId());
    jobConfigHistoryDTO.setClusterName(jobConfigHistory.getClusterName());
  ...
  public static JobConfigHistoryDTO to(JobConfig jobConfig) {
    ...
    jobConfigHistoryDTO.setClusterId(jobConfig.getClusterId());
    jobConfigHistoryDTO.setClusterName(jobConfig.getClusterName());
