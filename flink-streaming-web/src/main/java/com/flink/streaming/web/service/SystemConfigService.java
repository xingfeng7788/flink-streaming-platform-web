...
public interface SystemConfigService {
   ...
   * @time 01:23
   */
  String getYarnRmHttpAddress(Long clusterId);
   ...
   * @date 2022/10/11
   */
  String getFlinkAddress(Long clusterId, DeployModeEnum deployModeEnum);
   ...
   * @time 10:52
   */
  String getFlinkHttpAddress(Long clusterId, DeployModeEnum deployModeEnum);
   ...
   * @date 2022/10/21
   */
  String getFlinkUrl(Long clusterId, DeployModeEnum deployModeEnum);
  ...
  String defaultSavepointRootPath();

  String getFlinkUIAddress(Long clusterId);
}
