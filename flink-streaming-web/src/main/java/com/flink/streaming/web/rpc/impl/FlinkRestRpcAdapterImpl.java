...
public class FlinkRestRpcAdapterImpl implements FlinkRestRpcAdapter {
  ...
  @Override
  public JobStandaloneInfo getJobInfoForStandaloneByAppId(Long clusterId, String appId,
    ...
    try {
      String url = HttpUtil.buildUrl(systemConfigService.getFlinkHttpAddress(clusterId, deployModeEnum),
  ...
  @Override
  public void cancelJobForFlinkByAppId(Long clusterId, String jobId, DeployModeEnum deployModeEnum) {
  ...
  @Override
  public String savepointPath(Long clusterId, String jobId, DeployModeEnum deployModeEnum) {
    if (StringUtils.isEmpty(jobId)) {
      throw new BizException(SysErrorEnum.PARAM_IS_NULL);
    }
    try {
